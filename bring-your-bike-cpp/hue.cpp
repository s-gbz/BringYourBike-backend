...
JNIEXPORT void JNICALL Java_de_trzpiot_bringyourbike_service_LightService_switchOn
...
JNIEXPORT void JNICALL Java_de_trzpiot_bringyourbike_service_LightService_switchOff
  (JNIEnv *env, jobject thisObject, jstring bridgeIp, jstring bridgeUsername, jlong lightId)
{
  HueLight light = get(env, bridgeIp, bridgeUsername, lightId);
  light.Off();
...
JNIEXPORT void JNICALL Java_de_trzpiot_bringyourbike_service_LightService_setColor
...
JNIEXPORT void JNICALL Java_de_trzpiot_bringyourbike_service_LightService_setBrightness
